...
Puppet::Type.newtype(:opn_haproxy_group) do
  desc <<-DOC
    ...
    @example Define a HAProxy group
  ...
  newparam(:name, namevar: true) do
    desc <<-DOC
      The resource title in "group_name@device_name" format.

      The "group_name" portion (before "@") is the identifier used in the
