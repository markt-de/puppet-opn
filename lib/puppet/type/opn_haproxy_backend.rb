...
Puppet::Type.newtype(:opn_haproxy_backend) do
  ...
  PuppetX::Opn::TypeHelper.setup(self,
    ...
    autorequires: {
      ...
      opn_haproxy_action: { field: 'linkedActions', multiple: true },
      opn_haproxy_errorfile: { field: 'linkedErrorfiles', multiple: true },
      opn_haproxy_user: { field: 'basicAuthUsers', multiple: true },
      opn_haproxy_group: { field: 'basicAuthGroups', multiple: true },
    })
end
