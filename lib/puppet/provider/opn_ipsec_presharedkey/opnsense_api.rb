...
Puppet::Type.type(:opn_ipsec_presharedkey).provide(:opnsense_api) do
  desc 'Manages OPNsense IPsec pre-shared keys via the REST API.'
  ...
  def self.instances
    ...
    PuppetX::Opn::ApiClient.device_names.each do |device_name|
      ...
      Puppet.warning("opn_ipsec_presharedkey: failed to fetch from '#{device_name}': #{e.message}")
    end
