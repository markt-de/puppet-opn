...
describe Puppet::Type.type(:opn_user) do
  let(:type_name) { :opn_user }
  let(:title) { 'jdoe@opnsense01' }
  ...
  describe 'config insync?' do
    ...
    it 'returns true when password key is ignored during comparison' do
      is_config = { 'name' => 'jdoe', 'password' => '$2y$...' }
      should_config = { 'name' => 'jdoe', 'password' => 'plaintext' }
