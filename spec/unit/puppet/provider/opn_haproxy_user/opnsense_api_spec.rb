...
RSpec.describe provider_class do
  ...
  describe '.instances' do
    ...
    it 'translates UUIDs to names' do
      ...
      expect(instances.first.get(:name)).to eq('stats_user@fw01')
  ...
  describe '.prefetch' do
    it 'matches resources to instances' do
      ...
      resource = type_class.new(name: 'stats_user@fw01', config: { 'password' => 'secret' })
      resources = { 'stats_user@fw01' => resource }
  ...
  describe '#exists?' do
    it 'returns true when ensure is present' do
      provider = described_class.new(ensure: :present, name: 'stats_user@fw01')
      expect(provider.exists?).to be true
    end

    it 'returns false when ensure is absent' do
      provider = described_class.new(ensure: :absent, name: 'stats_user@fw01')
  ...
  describe '#destroy' do
    it 'deletes the user and marks reconfigure' do
      resource = type_class.new(name: 'stats_user@fw01')
      provider = described_class.new(
        ensure: :present,
        name: 'stats_user@fw01',
        device: 'fw01',
        uuid: 'aaa-bbb',
      )
  ...
  describe '#flush' do
    it 'translates names to UUIDs and updates the user' do
      resource = type_class.new(name: 'stats_user@fw01', config: { 'description' => 'Updated' })
      provider = described_class.new(
        ensure: :present,
        name: 'stats_user@fw01',
        device: 'fw01',
