...
RSpec.describe provider_class do
  ...
  describe '.instances' do
    ...
    it 'translates UUIDs to names' do
      ...
      expect(instances.first.get(:name)).to eq('http_frontend@opnsense01')
  ...
  describe '.prefetch' do
    it 'matches resources to instances' do
      ...
      resources = { 'http_frontend@opnsense01' => resource }
  ...
  describe '#exists?' do
    it 'returns true when ensure is present' do
      provider = described_class.new(ensure: :present, name: 'http_frontend@opnsense01')
      expect(provider.exists?).to be true
    end

    it 'returns false when ensure is absent' do
      provider = described_class.new(ensure: :absent, name: 'http_frontend@opnsense01')
  ...
  describe '#destroy' do
    it 'deletes the frontend and marks reconfigure' do
      resource = type_class.new(name: 'http_frontend@opnsense01')
      provider = described_class.new(
        ensure: :present,
        name: 'http_frontend@opnsense01',
        device: 'opnsense01',
        uuid: 'aaa-bbb',
      )
  ...
  describe '#flush' do
    it 'translates names to UUIDs and updates the frontend' do
      resource = type_class.new(name: 'http_frontend@opnsense01', config: { 'mode' => 'tcp' })
      provider = described_class.new(
        ensure: :present,
        name: 'http_frontend@opnsense01',
        device: 'opnsense01',
