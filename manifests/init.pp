...
class opn (
  ...
  $acmeclient_settings.each |String $device_name, Hash $settings_options| {
    ...
    opn_acmeclient_settings { $device_name:
      ...
      config  => $settings_options['config'],
      require => Class['opn::config'],
    }
  }
